...
<div className="bgc-lightGray" style={{width:"100%",overflow:"hide"}}>
    ...
    <div className="hide-on-print" style={{width:"100%",display:"flex"}}
    >
        <div className="bd-black hide-on-print" style={{width:`${filterData.widthLeft}%`}}>
            {
               renderFilter()
            }
        </div>
        <div className="bd-black hide-on-print" style={{width:`${100-filterData.widthLeft}%`}}>
    ...
    <div className="hide-on-print" style={{width:"97%",padding:"1rem"}}>
    {filterData.showRange
    ?renderTableRangeBar({
        showRange:filterData.showRange,
    ...
    <div style={{width:"100%"}}>
        ...
        {filterData.showAdd        
        ?<Sticker 
            loadData={filterData.loadData}
            isAdd={true}
            confirmFunc1={submitFunctionAdd}
            confirmFunc2={()=>{}}
            cancelFunc={submitFunctionCancel}
            selectProduct={filterData.selectProduct}
            addToSelectProduct={addToSelectProduct}
            deleteSelectProduct={deleteSelectProduct}
        />
        :null
        }

        {filterData.showEdit&&filterData.editData        
        ?<Sticker 
            loadData={filterData.editData}
            isAdd={false}
            confirmFunc1={submitFunctionEdit}
            confirmFunc2={submitFunctionAdd}
            cancelFunc={submitFunctionCancel}
            selectProduct={filterData.selectProduct}
            addToSelectProduct={addToSelectProduct}
            deleteSelectProduct={deleteSelectProduct}
