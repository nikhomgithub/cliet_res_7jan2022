...
const PageFilterInput=({
    show,setShow,
    title,

    filterTemplate,
    stickerInputState,
    setStickerInputState,
...
export default PageFilterInput